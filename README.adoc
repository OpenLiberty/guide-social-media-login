...
The [hotspot=socialLogin file=1]`socialLogin-1.0` feature definition enables the Social Media Login feature in the
...
[hotspot=githubLogin file=1]`githubLogin` configuration element with the values of `github.client.id` and
...
The [hotspot file=3]`securedHello.jsp` page contains a **Log out** button that makes a
