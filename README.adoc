...
The `hello.html` page contains a [hotspot=loginBtn file=2]`login` button that redirects to the
...
When users access this endpoint by clicking on the [hotspot=loginBth file=2]`login` button, they will be prompted to authenticate using GitHub.
