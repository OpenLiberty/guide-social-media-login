...
By the end of this guide, you will be able to authenticate users to your web service using GitHub and LinkedIn.
...
To obtain OAuth 2.0 client ID and client secret credentials for accessing the LinkedIn developer API, you must
create a LinkedIn app. A requirement for creating a LinkedIn app is to associate a company to your application.
The company page's admin must verify the application.
You also need a square image (min. 100px x 100px) for the logo.

If you don't have a company page,
you can create one https://www.linkedin.com/company/setup/new/[here^].
To create a new company page, you need a square image (min. 300px x 300px) for the logo.

To create a new LinkedIn application,
...
Navigate to the "Auth" tab. Under the "OAuth 2.0 settings" section,
