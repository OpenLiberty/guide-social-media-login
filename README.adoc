...
When you access the [hotspot file=1]`hello.html` page, find the login button, defined in
[hotspot=btnLogin file=1]`hello.html`.
...
After you log in with your GitHub account, you will need to authorize access to your GitHub user data
by the OAuth application you created in the prerequisites section.
...
redirected to `\https://localhost:9080/api/hello`. As long as you are logged into GitHub, you will not be required
to log into GitHub by entering your GitHub credentials.
