...
Make sure that the [hotspot=amazonLogin]`id` of your [hotspot=amazonLogin]`<oauth2Login />` configuration matches the redirect URL (if you set the [hotspot=amazonLogin]`id` to `amazonLogin`, the redirect URL must end with `.../amazonLogin`).
